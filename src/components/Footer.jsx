...
function Footer() {
  return (
    <footer className="bg-[#F2F2F2]">
      <div className="mx-auto max-w-[1200px] px-5 md:px-8 lg:px-[60px]">
        <div className="flex min-h-[149px] flex-col items-center justify-center md:flex-row md:justify-between">
          
          {/* Logo */}
          <div className="w-full border-b border-[#d9d9d9] py-8 text-center md:w-auto md:border-none md:py-0">
